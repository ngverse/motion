// const headShakeAnimation = animate(
//   '1s ease-in-out',
//   keyframes([
...
/**
 * ref: https://github.com/animate-css/animate.css/blob/main/source/attention_seekers/shake.css
 */
...
export const shake = createAnimateMotion(
  keyframes([
    style({ transform: 'translateX(0)', offset: 0 }),
    style({ transform: 'translateX(-6px) rotateY(-9deg)', offset: 0.065 }),
    style({ transform: 'translateX(5px) rotateY(7deg)', offset: 0.185 }),
